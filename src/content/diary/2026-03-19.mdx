...
![Zero to Agent: Vercel x DeepMind Hackathon banner](/cdn/content/agent.png)
...
![Early usage plan visual](/cdn/content/diary/brain.png)
...
<div className="not-prose my-6 grid grid-cols-1 gap-4 md:grid-cols-2">
  <img
    src="/cdn/content/diary/cyberminds.png"
  ...
  />
  <img
    src="/cdn/content/diary/recent.png"
